...
Public Class frmDefineWallItems
    ...
    Public MyKeyLabel(6) As Label
    Public MyKeys(6, MaxKeys + 1) As TextBox
    Public MyHeaders() As String = {"itemnr", "itemname", "picturename", "width", "height"}
    Public ColWidths() As Integer = {60, 100, 100, 60, 60}
    ...
    Private Sub frmDefineWallItems_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub LoadKeys()
        ...
        mysql = "select * from Itemtypes where itemnr > 700 and itemnr < 801 order by itemnr"
    ...
    Private Sub TextEntered(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If ind <> CurrentRownr Then
            ...
            Try
                PictureBox1.Image = Bitmap.FromFile(Gamefile + "\wallitems\" + pictname1)
    ...
    Private Sub UpdateKeys()
        ...
        For i = 1 To MaxKeys
            ...
            End If
        Next
        MsgBox("The new Wallitems have been saved succesfully !")
    ...
    Private Sub ClearAllkeys()
        ...
        mysql = "Delete * from Itemtypes where itemnr > 700 and itemnr < 801"
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        If KeysChanges = True Then
            rc = MsgBox("Do you want to store these Wallitems ?", MsgBoxStyle.YesNoCancel)
