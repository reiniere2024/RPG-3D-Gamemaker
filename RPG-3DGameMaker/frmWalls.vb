...
Public Class frmWalls
    ...
    Public MyHeaders() As String = {"wallnr", "wallname", "picturename"}
    ...
    Private Sub frmWalls_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub CreateHeaders()
        ...
        Button5.Location = New Point(labelX + maxwidth + 10, PictureBox1.Location.Y + PictureBox1.Height + 10)
        Button6.Location = New Point(Button5.Location.X + Button5.Width + 5, PictureBox1.Location.Y + PictureBox1.Height + 10)
        TextBox1.Location = New Point(Button6.Location.X + Button6.Width + 5, PictureBox1.Location.Y + PictureBox1.Height + 10)
    ...
    Private Sub TextEntered(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If ind <> CurrentRownr Then
            ...
            pictname1 = pictname + "-L01.bmp" '"A-L01.bmp"
            pictname2 = pictname + "B-L01.bmp"
            fnam1 = Gamefile + "\walls\" + pictname1
            fnam2 = Gamefile + "\walls\" + pictname2
    ...
    Private Sub UpdateDoors()
        ...
        For i = 1 To MaxDoors
            ...
            End If
        Next
        MsgBox("The new Walls have been saved succesfully !")
    ...
    Private Sub InsertDoors(ByVal nr As String, ByVal name As String, ByVal pict As String)
        ...
        mystr = mystr + name + "','"
        mystr = mystr + pict + "'"
        mysql = "Insert into Walls values (" + mystr + ")"
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        If DoorsChanges = True Then
            rc = MsgBox("Do you want to store these Walls ?", MsgBoxStyle.YesNoCancel)
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        ...
        Select Case Doortype
            Case 1
                pictname1 = pictname + "-L01.bmp"
                pictname2 = pictname + "B-L01.bmp"
            Case 2
                pictname1 = pictname + "-L02.bmp"
                pictname2 = pictname + "B-L02.bmp"
            Case 3
                pictname1 = pictname + "-L03.bmp"
