...
Public Class frmEffects
    ...
    Public MyHeaders() As String = {"effectnr", "effectname", "picturename", "width", "height"}
    ...
    Public Sub LoadKeys()
        ...
        mysql = "select * from Itemtypes where itemnr > 800 and itemnr < 851 order by itemnr"
    ...
    Private Sub TextEntered(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If ind <> CurrentRownr Then
            ...
            Try
                PictureBox1.Image = Bitmap.FromFile(Gamefile + "\effects\" + pictname1)
    ...
    Private Sub UpdateKeys()
        ...
        For i = 1 To MaxKeys
            ...
            End If
        Next
        MsgBox("The new Effects have been saved succesfully !")
    ...
    Private Sub ClearAllkeys()
        ...
        mysql = "Delete * from Itemtypes where itemnr > 800 and itemnr < 851"
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        If KeysChanges = True Then
            rc = MsgBox("Do you want to store these Effects ?", MsgBoxStyle.YesNoCancel)
