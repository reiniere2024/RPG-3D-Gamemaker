...
Public Class frmMageSpells
    ...
    Private Sub frmMageSpells_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub LoadKeys()
        ...
        mysql = "select * from Itemtypes where itemnr < 301 and itemnr > 200 order by itemnr"
    ...
    Private Sub ClearAllkeys()
        ...
        mysql = "Delete * from Itemtypes where itemnr < 301 and itemnr > 200 "
