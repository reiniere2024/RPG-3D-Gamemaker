...
Public Class frmGameField2
    ...
    Public MyDoorLabel(48) As Label
    Public MyDoortypes(48, MaxDoors + 1) As TextBox
    Public MyHeaders() As String = {"fieldnr", "fieldname", "pictname", "mx", "my", "mw", "mh", "x1", "y1", "w1", "h1", "dx1", "dy1", "x2", "y2", "w2", "h2", "dx2", "dy2", "x3", "y3", "w3", "h3", "dx3", "dy3", "x4", "y4", "w4", "h4", "dx4", "dy4", "x5", "y5", "w5", "h5", "dx5", "dy5", "x6", "y6", "w6", "h6", "dx6", "dy6", "x7", "y7", "w7", "h7"}
    Public ColWidths() As Integer = {50, 100, 100, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30}
    ...
    Public Sub FillDoors()
        ...
        For i = 0 To dsDoortypes.Tables(0).Rows.Count - 1
            For j = 0 To 10
                MyDoortypes(j + 1, i + 1).Text = dsDoortypes.Tables(0).Rows(i).Item(j)
            Next
            ...
            'MyDoortypes(4, i + 1).Text = dsDoortypes.Tables(0).Rows(i).Item(3)
            'MyDoortypes(5, i + 1).Text = dsDoortypes.Tables(0).Rows(i).Item(4)
            'MyDoortypes(6, i + 1).Text = dsDoortypes.Tables(0).Rows(i).Item(5)
    ...
    Public Sub LoadDoors()
        ...
        mysql = "select * from GameField"

        da.SelectCommand = New OleDbCommand(mysql, myconnection1)
        myconnection1.Open()

        da.Fill(dsDoortypes, "GameField")
    ...
    Private Sub TextEntered(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim ind As Integer
        Dim str, pictname1, pictname, fnam1 As String
        Dim btn As TextBox
        ...
        If ind <> CurrentRownr Then
            ...
            pictname1 = pictname
            fnam1 = Gamefile + "\gamefield\" + pictname1
    ...
    Private Sub UpdateDoors()
        ...
        For i = 1 To MaxDoors
            ...
            End If
        Next
        MsgBox("The new GameFields have been saved succesfully !")
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        If DoorsChanges = True Then
            rc = MsgBox("Do you want to store these GameFields ?", MsgBoxStyle.YesNoCancel)
