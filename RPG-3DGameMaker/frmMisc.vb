...
Public Class frmMisc
    ...
    Public MyHeaders() As String = {"itemnr", "itemname", "picturename", "width", "height", "picturefloor"}
    ...
    Public Sub LoadKeys()
        ...
        mysql = "select * from Itemtypes where itemnr > 900 and itemnr < 999 order by itemnr"
    ...
    Private Sub TextEntered(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If ind <> CurrentRownr Then
            ...
            Try
                PictureBox1.Image = Bitmap.FromFile(Gamefile + "\misc\" + pictname1)
                PictureBox2.Image = Bitmap.FromFile(Gamefile + "\misc\" + pictname2)
    ...
    Private Sub UpdateKeys()
        ...
        For i = 1 To MaxKeys
            ...
            End If
        Next
        MsgBox("The new Items have been saved succesfully !")
    ...
    Private Sub ClearAllkeys()
        ...
        mysql = "Delete * from Itemtypes where itemnr > 900 and itemnr < 999"
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        If KeysChanges = True Then
            rc = MsgBox("Do you want to store these Items ?", MsgBoxStyle.YesNoCancel)
