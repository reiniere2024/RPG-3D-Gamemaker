...
Public Class frmBackdrops
    ...
    Public MyHeaders() As String = {"dropnr", "dropname", "picturename"}
    ...
    Private Sub frmBackdrops_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub LoadDoors()
        ...
        mysql = "select * from BackDrops"

        da.SelectCommand = New OleDbCommand(mysql, myconnection1)
        myconnection1.Open()

        da.Fill(dsDoortypes, "BackDrops")
    ...
    Private Sub TextEntered(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If ind <> CurrentRownr Then
            ...
            pictname1 = pictname + ".bmp" '"A-L01.bmp"
            fnam1 = Gamefile + "\backdrops\" + pictname1
    ...
    Private Sub UpdateDoors()
        ...
        For i = 1 To MaxDoors
            ...
            End If
        Next
        MsgBox("The new BackDrops have been saved succesfully !")
    ...
    Private Sub InsertDoors(ByVal nr As String, ByVal name As String, ByVal pict As String)
        ...
        mystr = mystr + name + "','"
        mystr = mystr + pict + "'"
        mysql = "Insert into BackDrops values (" + mystr + ")"
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        If DoorsChanges = True Then
            rc = MsgBox("Do you want to store these BackDrops ?", MsgBoxStyle.YesNoCancel)
