...
Public Class frmClothes
    ...
    Public MyHeaders() As String = {"clothesnr", "clothesname", "picturename", "width", "height", "picturefloor"}
    ...
    Private Sub frmClothes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub LoadKeys()
        ...
        mysql = "select * from Itemtypes where itemnr > 400 and itemnr < 501 order by itemnr"
    ...
    Private Sub TextEntered(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If ind <> CurrentRownr Then
            ...
            Try
                PictureBox1.Image = Bitmap.FromFile(Gamefile + "\clothes\" + pictname1)
                PictureBox2.Image = Bitmap.FromFile(Gamefile + "\clothes\" + pictname2)
    ...
    Private Sub UpdateKeys()
        ...
        For i = 1 To MaxKeys
            ...
            End If
        Next
        MsgBox("The new Clothes have been saved succesfully !")
    ...
    Private Sub ClearAllkeys()
        ...
        mysql = "Delete * from Itemtypes where itemnr > 400 and itemnr < 501"
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        If KeysChanges = True Then
            rc = MsgBox("Do you want to store these Clothes ?", MsgBoxStyle.YesNoCancel)
