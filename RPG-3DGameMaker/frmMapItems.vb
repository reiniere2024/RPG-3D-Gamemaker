...
Public Class frmMapItems
    ...
    Private Sub frmMapItems_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim game As Integer
