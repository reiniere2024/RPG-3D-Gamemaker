...
Public Class frmSideWalls
    ...
    Private Sub frmSideWalls_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub LoadDoors()
        ...
        mysql = "select * from SideWalls"

        da.SelectCommand = New OleDbCommand(mysql, myconnection1)
        myconnection1.Open()

        da.Fill(dsDoortypes, "SideWalls")
    ...
    Private Sub TextEntered(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If ind <> CurrentRownr Then
            ...
            pictname1 = pictname + "L-L01.png"
            pictname2 = pictname + "R-L01.png"
    ...
    Private Sub UpdateDoors()
        ...
        For i = 1 To MaxDoors
            ...
            End If
        Next
        MsgBox("The new SideWalls have been saved succesfully !")
    ...
    Private Sub InsertDoors(ByVal nr As String, ByVal name As String, ByVal pict As String)
        ...
        mystr = mystr + name + "','"
        mystr = mystr + pict + "'"
        mysql = "Insert into SideWalls values (" + mystr + ")"
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        If DoorsChanges = True Then
            rc = MsgBox("Do you want to store these SideWalls ?", MsgBoxStyle.YesNoCancel)
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        ...
        Select Case Doortype
            Case 1
                ...
                pictname2 = pictname + "R-L01.png"
            Case 2
                pictname1 = pictname + "L-L02.png"
                pictname2 = pictname + "R-L02.png"
            Case 3
                pictname1 = pictname + "L-L03.png"
                pictname2 = pictname + "R-L03.png"
            Case 4
                pictname1 = pictname + "L-L04.png"
                pictname2 = pictname + "R-L04.png"
        End Select
        fnam1 = Gamefile + "\walls\" + pictname1
        fnam2 = Gamefile + "\walls\" + pictname2
        PictureBox1.Image = Bitmap.FromFile(fnam1)
