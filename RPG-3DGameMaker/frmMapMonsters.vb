...
Public Class frmMapMonsters
    ...
    Private Sub frmMapMonsters_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub SelectMaps(ByVal gamenr As Integer)
        ...
        mysql = "select * from Mapmonsters where gameid = " + gamenr.ToString() + " order by gameid,mapnr"

        da2.SelectCommand = New OleDbCommand(mysql, myconnection1)
        da2.Fill(dsMapitems, "Mapmonsters")
        myconnection1.Close()
    ...
    Public Function GetItemstring(ByVal gameid As Integer, ByVal mapnr As Integer) As String
        ...
        mysql = "select items from Mapmonsters where gameid = " + gameid.ToString() + " and mapnr = " + mapnr.ToString()
    ...
    Public Sub AddItemImage(ByVal pictx As Integer, ByVal picty As Integer, ByVal pictnum As Integer)
        ...
        filename = Gamefile + "\monsters\" + pictname
    ...
    Private Sub ClickButton(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        ElseIf cbxEdit.Checked = True Then
            If MyFields(x, y) = 1 Then 'only items on the road
    ...
    Public Function GetItemName(ByVal itemnr As Integer) As String
        ...
        mysql = "select monstername from Monsters where monsternr = " + itemnr.ToString()
    ...
    Public Function GetItemPict(ByVal itemnr As Integer) As String
        ...
        mysql = "select pictname from Monsters where monsternr = " + itemnr.ToString()
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        For y = 1 To 32
            ...
            Next
        Next
        mysql = "Update Mapmonsters set items = '" + map + "' where gameid = " + Gameid.ToString() + " and mapnr = " + curmap.ToString()
        ...
        Try
            ...
            MsgBox("The Game Monsters have been saved succesfully !")
