...
Public Class frmStairTypes
    ...
    Public MyHeaders() As String = {"stairsnr", "srairsname", "picturename"}
    ...
    Private Sub frmStairTypes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub LoadDoors()
        ...
        mysql = "select * from Stairstypes"

        da.SelectCommand = New OleDbCommand(mysql, myconnection1)
        myconnection1.Open()

        da.Fill(dsDoortypes, "Stairstypes")
    ...
    Private Sub TextEntered(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If ind <> CurrentRownr Then
            ...
            fnam1 = Gamefile + "\stairs\" + pictname1
            fnam2 = Gamefile + "\stairs\" + pictname2
    ...
    Private Sub UpdateDoors()
        ...
        For i = 1 To MaxDoors
            ...
            End If
        Next
        MsgBox("The new Stairstypes have been saved succesfully !")
    ...
    Private Sub InsertDoors(ByVal nr As String, ByVal name As String, ByVal pict As String)
        ...
        mystr = mystr + name + "','"
        mystr = mystr + pict + "'"
        mysql = "Insert into Stairstypes values (" + mystr + ")"
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        If DoorsChanges = True Then
            rc = MsgBox("Do you want to store these Stairstypes ?", MsgBoxStyle.YesNoCancel)
