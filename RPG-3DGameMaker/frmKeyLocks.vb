...
Public Class frmKeyLocks
    ...
    Public MyHeaders() As String = {"keyholenr", "keyholename", "picturename", "width", "height"}
    ...
    Private Sub frmKeyLocks_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub LoadKeys()
        ...
        mysql = "select * from Itemtypes where itemnr > 50 and itemnr < 101 order by itemnr"
    ...
    Private Sub UpdateKeys()
        ...
        For i = 1 To MaxKeys
            ...
            End If
        Next
        MsgBox("The new Keylocks have been saved succesfully !")
    ...
    Private Sub ClearAllkeys()
        ...
        mysql = "Delete * from Itemtypes where itemnr < 101 and itemnr > 50"
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        If KeysChanges = True Then
            rc = MsgBox("Do you want to store these Keylocks ?", MsgBoxStyle.YesNoCancel)
