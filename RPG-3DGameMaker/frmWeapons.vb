...
Public Class frmWeapons
    ...
    Public MyHeaders() As String = {"weaponnr", "weaponname", "picturename", "width", "height", "picturefloor"}
    ...
    Public Sub LoadKeys()
        ...
        mysql = "select * from Itemtypes where itemnr < 201 and itemnr > 100 order by itemnr"
    ...
    Private Sub UpdateKeys()
        ...
        For i = 1 To MaxKeys
            ...
            End If
        Next
        MsgBox("The new Weapons have been saved succesfully !")
    ...
    Private Sub ClearAllkeys()
        ...
        mysql = "Delete * from Itemtypes where itemnr < 201 and itemnr > 100 "
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        If KeysChanges = True Then
            rc = MsgBox("Do you want to store these Weapons ?", MsgBoxStyle.YesNoCancel)
