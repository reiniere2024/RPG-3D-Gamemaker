...
Public Class frmMonsters
    ...
    Public MaxKeys As Integer = 100
    Public MaxRowsVisible = 20
    Public CurrentPageNr As Integer = 1
    Public CurrentRownr As Integer = 0
    Public OldRownr As Integer = 0

    Public MyKeyLabel(8) As Label
    Public MyKeys(8, MaxKeys + 1) As TextBox
    Public MyHeaders() As String = {"monsternr", "monstername", "width", "height", "picturename", "picturename2", "picturename3"}
    Public ColWidths() As Integer = {65, 100, 60, 60, 100, 100, 100}
    ...
    Private Sub frmMonsters_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub FillKeys()
        ...
        For i = 0 To dsKeys.Tables(0).Rows.Count - 1
            ...
            MyKeys(2, i + 1).Text = dsKeys.Tables(0).Rows(i).Item(2)
            MyKeys(3, i + 1).Text = dsKeys.Tables(0).Rows(i).Item(3)
            MyKeys(4, i + 1).Text = dsKeys.Tables(0).Rows(i).Item(4)
            MyKeys(5, i + 1).Text = dsKeys.Tables(0).Rows(i).Item(5)
            MyKeys(6, i + 1).Text = dsKeys.Tables(0).Rows(i).Item(6)
            MyKeys(7, i + 1).Text = dsKeys.Tables(0).Rows(i).Item(7)
    ...
    Public Sub LoadKeys()
        ...
        mysql = "select * from Monsters order by monsternr"

        da.SelectCommand = New OleDbCommand(mysql, myconnection1)
        myconnection1.Open()

        da.Fill(dsKeys, "Monsters")
    ...
    Public Sub CreateHeaders()
        ...
        PictureBox1.Location = New Point(Button2.Location.X, TextStartY + Button2.Height + 5)
        PictureBox2.Location = New Point(Button2.Location.X, PictureBox1.Location.Y + PictureBox1.Height + 5)
        PictureBox3.Location = New Point(Button2.Location.X, PictureBox2.Location.Y + PictureBox2.Height + 5)
    ...
    Private Sub TextEntered(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim ind As Integer
        Dim str, pictname1, pictname2, pictname3 As String
        Dim btn As TextBox
        ...
        If ind <> CurrentRownr Then
            ...
            Next
            'show pictures
            pictname1 = MyKeys(5, CurrentRownr).Text
            pictname2 = MyKeys(6, CurrentRownr).Text
            pictname3 = MyKeys(7, CurrentRownr).Text
            Try
                PictureBox1.Image = Bitmap.FromFile(Gamefile + "\monsters\" + pictname1)
                PictureBox2.Image = Bitmap.FromFile(Gamefile + "\monsters\" + pictname2)
                PictureBox3.Image = Bitmap.FromFile(Gamefile + "\monsters\" + pictname3)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        For i = 0 To MaxKeys - 1
            ...
            MyKeys(7, i + 1).Location = New Point(MyKeys(7, i + 1).Location.X, MyKeys(7, i + 1).Location.Y - ScrollHeight)
    ...
    Private Sub UpdateKeys()
        ...
        Dim knr, kname, kpict, kw, kh, kpict2, kpict3 As String
        ...
        For i = 1 To MaxKeys
            ...
            kw = MyKeys(3, i).Text
            kh = MyKeys(4, i).Text
            kpict = MyKeys(5, i).Text
            kpict2 = MyKeys(6, i).Text
            kpict3 = MyKeys(7, i).Text
            If knr <> "" Then
                Me.InsertKeys(knr, kname, kw, kh, kpict, kpict2, kpict3)
            End If
        Next
        MsgBox("The new Monsters have been saved succesfully !")
    ...
    Private Sub InsertKeys(ByVal nr As String, ByVal name As String, ByVal w As String, ByVal h As String, ByVal pict As String, ByVal pict2 As String, ByVal pict3 As String)
        ...
        mystr = mystr + pict2 + "','"
        mystr = mystr + pict3 + "')"
        mysql = "Insert into Monsters values ('" + mystr + ")"
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        If KeysChanges = True Then
            rc = MsgBox("Do you want to store these Monsters ?", MsgBoxStyle.YesNoCancel)
